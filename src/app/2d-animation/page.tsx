  ...
  return (
    <>
      ...
      <main className="flex flex-col min-h-screen pt-20 bg-[#050505] text-white font-sans">
        ...
        <section className="relative min-h-[60vh] flex items-center justify-center py-24 bg-cover bg-center" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1626785774573-4b799315345d?q=80&w=1200&auto=format&fit=crop')" }}>
          ...
          <div className="max-w-5xl mx-auto px-6 text-center relative z-10 drop-shadow-[0_4px_12px_rgba(0,0,0,0.5)]">
            ...
            <h1 className="font-display font-bold text-4xl sm:text-6xl tracking-tight leading-tight mb-8">
              2D <br />
              <span className="text-[#BE1E2E]">Animation Courses at ZICA Pitampura</span>
            </h1>
            <p className="text-zinc-300 text-sm sm:text-lg max-w-3xl mx-auto leading-relaxed font-light italic">
              &ldquo;Build a Strong Career Foundation with Our Practical, Job-Oriented 2D Animation Program Across Multiple Industries&rdquo;
            </p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="text-center mt-20">
              <h3 className="font-display font-bold text-2xl sm:text-3xl text-white">
                Professional Program In 2D Animation
              </h3>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mb-12">
                  <div>
                    ...
                    <p className="text-zinc-400 text-xs sm:text-sm leading-relaxed font-light">
                      Well laid out assessment procedure ensures the students acceptability as distinguished professionals in the world of Animation. ZICA&apos;s placement cell provides placement assistance to all ZICA students across the country. ZICA training academy is equipped with high-end animation tools, 2D animation facilities, 3D software, Visual FX Labs and Imaging Technologies.
                    </p>
                  </div>
                  <div>
                    <h3 className="font-display font-bold text-lg mb-3">
                    ...
                    <p className="text-zinc-400 text-xs sm:text-sm leading-relaxed font-light">
                      Students walk away with a rich portfolio comprising the best Digital paint, Matte paint, Character design, and 2D digital Animation portfolio. This portfolio will be a gateway to joining the animation industry.
                    </p>
                  </div>
                </div>
        ...
        <section className="py-24 border-b border-white/5 relative bg-[#090909]">
          <div className="max-w-4xl mx-auto px-6">
            <h2 className="font-display font-bold text-3xl sm:text-4xl text-center mb-16 tracking-tight leading-tight">
              2D Animation Program <span className="text-[#BE1E2E]">Structure</span>
            </h2>
