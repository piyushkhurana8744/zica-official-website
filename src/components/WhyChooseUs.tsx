...
export default function WhyChooseUs() {
  return (
    <section id="why-choose-us" data-section-theme="dark" className="relative py-24 bg-[#0A0A0A] overflow-hidden border-b border-[rgba(231, 107, 36,0.12)]">
      {/* Background Gradient */}
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 text-left">
        ...
        <div className="max-w-5xl mb-16">
          <h2 className="font-display font-bold text-3xl sm:text-5xl text-white tracking-tight leading-tight mb-6 uppercase">
            The Right Place to <span className="text-[#E76B24]">Achieve Your Goals</span>
          </h2>
          <p className="text-[#D1D5DB] text-sm sm:text-base leading-relaxed font-light">
            Zee Institute of Creative Art (<span className="text-[#E76B24] font-medium">ZICA</span>), established in <span className="text-[#E76B24] font-medium">1995</span>, is India&apos;s pioneering academy offering comprehensive training in both classical and digital animation. ZICA specializes in 2D Animation, 3D Animation, Visual Effects (VFX), Gaming, Graphic Design, Web Design, Digital Marketing, and Digital Photography, empowering youth with industry-relevant skills.
          </p>
        </div>
          ...
          {FEATURES.map((item, idx) => {
            ...
            return (
              <motion.div
                ...
                className="flex flex-col items-start p-6 bg-[#181818] border border-[rgba(231, 107, 36,0.12)] rounded-2xl shadow-sm hover:border-[#E76B24] hover:scale-[1.02] hover:-translate-y-1 transition-all duration-300 group"
              >
                {/* Icon Container with Red Outline */}
                <div className="h-10 w-10 rounded-lg border border-[#E76B24] flex items-center justify-center text-[#E76B24] bg-[#0A0A0A] group-hover:bg-[#E76B24] group-hover:text-white transition-all duration-300 mb-4 shadow-sm">
                ...
                <h3 className="font-display font-bold text-sm sm:text-base text-white mb-2 leading-snug tracking-tight uppercase">
                  ...
                  <span className="text-[#E76B24]">{item.titleRed}</span>
                </h3>
