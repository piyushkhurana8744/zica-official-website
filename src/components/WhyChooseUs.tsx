...
export default function WhyChooseUs() {
  return (
    <section id="why-choose-us" className="relative py-24 bg-[#050505] overflow-hidden border-b border-white/5">
      {/* Background Gradient */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[600px] bg-red-950/5 rounded-full blur-[140px] pointer-events-none" />
          ...
          {FEATURES.map((item, idx) => {
            ...
            return (
              ...
              >
                ...
                <div className="h-10 w-10 rounded-lg border border-[#BE1E2E] flex items-center justify-center text-[#BE1E2E] bg-transparent group-hover:bg-[#BE1E2E] group-hover:text-white transition-all duration-300 mb-4">
                  <Icon className="h-5 w-5" />
                </div>

                {/* Title */}
                <h3 className="font-display font-bold text-sm sm:text-base text-white mb-2 leading-snug tracking-tight">
