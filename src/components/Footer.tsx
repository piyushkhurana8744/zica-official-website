        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-12">
          ...
          <div className="lg:col-span-5 flex flex-col space-y-6 text-left">
            ...
            <p className="text-zinc-400 text-xs sm:text-sm leading-relaxed font-light max-w-md">
              Reflect on your teaching or work performance, seek feedback from supervisors, and continuously strive to improve your skills.
            </p>
          </div>

          {/* Column 2: Page Links (Span 2) */}
          <div className="lg:col-span-2 text-left">
            <h4 className="font-display font-bold text-sm uppercase tracking-widest text-primary mb-6">
              PAGE LINKS
            </h4>
