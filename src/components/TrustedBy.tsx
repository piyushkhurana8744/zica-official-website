...
export default function TrustedBy() {
  return (
    <section id="trusted-by" data-section-theme="dark" className="relative py-24 bg-[#0A0A0A] overflow-hidden border-b border-[rgba(190,30,46,0.12)]">
      {/* Glow Effects */}
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            {/* Description */}
            <p className="text-[#D1D5DB] text-sm sm:text-base leading-relaxed italic mb-8 font-light max-w-lg border-l-2 border-[#BE1E2E] pl-4">
            ...
            <div className="grid grid-cols-3 gap-4 mb-8">
              {/* Anibrain Logo Card */}
              <div className="h-20 sm:h-24 bg-[#181818] rounded-xl flex items-center justify-center p-3 shadow-sm border border-[rgba(190,30,46,0.12)] hover:border-[#BE1E2E] hover:scale-[1.03] transition-all duration-300">
                <svg viewBox="0 0 200 60" className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
                  <rect x="15" y="12" width="30" height="30" fill="#BE1E2E" rx="4"/>
            ...
            {/* View All Button */}
            <a href="/placements" className="w-fit px-8 py-3.5 bg-[#BE1E2E] hover:bg-[#A31827] text-white font-semibold rounded-full shadow-sm hover:shadow-lg hover:scale-[1.02] transition-all duration-300 text-center font-sans text-xs uppercase tracking-wider">
              View All
            </a>
          </motion.div>
