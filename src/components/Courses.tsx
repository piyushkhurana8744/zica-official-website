      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <h2 className="font-display font-bold text-4xl sm:text-5xl text-[#111111] tracking-tight mb-6 leading-tight uppercase">
            Industry <span className="text-[#E76B24]">Flagship Courses</span>
          </h2>
          ...
          {COURSES_DATA.map((course, idx) => {
            ...
            return (
              <motion.div
                ...
                className="group relative bg-[#FFFFFF] border border-[rgba(231, 107, 36,0.12)] rounded-2xl p-6 shadow-sm hover:border-[#E76B24] hover:scale-[1.02] hover:-translate-y-1.5 hover:shadow-xl transition-all duration-300 flex flex-col justify-between overflow-hidden"
              >
                <div>
                  {/* Badge & Duration */}
                  <div className="flex items-center justify-between mb-6">
                    <span className="text-[9px] font-bold uppercase tracking-wider bg-brand-tint border border-[rgba(231, 107, 36,0.2)] text-[#E76B24] px-2.5 py-1 rounded-full font-sans">
                      {course.badge}
                    </span>
                  ...
                  <div className="flex items-center gap-3.5 mb-4">
                    <div className="h-10 w-10 rounded-xl bg-brand-tint border border-[rgba(231, 107, 36,0.15)] flex items-center justify-center text-[#E76B24] group-hover:bg-[#E76B24] group-hover:text-white transition-colors duration-300">
                      <IconComponent className="h-5 w-5" />
                    </div>
                    <h3 className="font-display font-bold text-base text-[#111111] leading-snug tracking-tight uppercase group-hover:text-[#E76B24] transition-colors duration-200">
                      {course.title}
                    </h3>
                  </div>
                  ...
                  <ul className="space-y-2 mb-8 border-t border-[rgba(231, 107, 36,0.06)] pt-4">
                ...
                <div className="mt-auto">
                  <div className="flex items-center justify-between text-xs font-semibold text-[#666666] mb-4 font-sans uppercase tracking-wider">
                    <span>Pricing</span>
                    <span className="text-[#E76B24] font-bold">Scholarship Available</span>
                  </div>

                  <Link href={course.href}>
                    <div className="w-full inline-flex items-center justify-center gap-2 py-3 rounded-xl text-xs font-semibold text-white bg-[#E76B24] hover:bg-[#C65516] transition-all duration-300 shadow-sm cursor-pointer hover:shadow-md">
